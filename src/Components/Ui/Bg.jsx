...
import { cn } from "../../lib/utils"; // Make sure path is correct based on your project
...
export const AuroraBackground = ({
  ...
  return (
    <main>
      <div
        className={cn(
          "transition-bg relative flex h-auto flex-col items-center justify-center bg-[#000A2C] text-slate-950 dark:bg-zinc-900",
          className
        )}
        {...props}
      >
        ...
        >
          <div
            className={cn(
              ...
              opacity-50 blur-[4px] invert filter will-change-transform 
