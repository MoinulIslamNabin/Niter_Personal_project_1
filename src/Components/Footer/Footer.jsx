...
const Footer = () => {
  return (
    <div className=" bg-gradient-to-l from-blue-700 via-cyan-200 to-blue-700">
      <footer className="container !mx-auto justify-items-center footer text-base-content border-black opacity-70 border-b lg:px-20 py-8">
